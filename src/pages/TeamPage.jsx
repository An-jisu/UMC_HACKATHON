...
export default function TeamPage() {
  ...
  return (
    <div className="mx-auto flex flex-col bg-gray w-[85%] h-[1300px] rounded-xl mt-10 gap-10 py-5">
      ...
      <button className="bg-white self-center p-4 text-xl font-bold w-1/3 rounded-xl bg-gradient-to-r  from-[#41FF76] to-[#94FF41] ">BackEnd 결과 보기</button>
    </div>
  );
}
